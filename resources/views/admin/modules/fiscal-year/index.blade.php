@section('meta')
<title>{{ config('app.name') }} | {{ __('Fiscal Years') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Fiscal Years'),
            'description' => __('Fiscal Year Introduction'),
            'breadcrum' => [
                __('Fiscal Years') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.fiscalyear.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('fiscal-year.create') }}" class="btn btn-primary">{{ __('Fiscal Year') }} {{ strtolower(__('Add')) }}</a>
