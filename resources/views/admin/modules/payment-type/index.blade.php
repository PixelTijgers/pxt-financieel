@section('meta')
<title>{{ config('app.name') }} | {{ __('Payment Types') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Payment Types'),
            'description' => __('Payment Type Introduction'),
            'breadcrum' => [
                __('Payment Types') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.paymenttype.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('payment-types.create') }}" class="btn btn-primary">{{ __('Payment Type') }} {{ strtolower(__('Add')) }}</a>
