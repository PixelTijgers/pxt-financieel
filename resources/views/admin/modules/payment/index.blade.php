@section('meta')
<title>{{ config('app.name') }} | {{ __('Payments') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Payments'),
            'description' => __('Payment Introduction'),
            'breadcrum' => [
                __('Payments') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.payment.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('payment.create') }}" class="btn btn-primary">{{ __('Payment') }} {{ strtolower(__('Add')) }}</a>
