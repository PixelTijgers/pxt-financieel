@section('meta')
<title>{{ config('app.name') }} | {{ __('Bankaccounts') }}</title>
@endsection
...
<x-adminLayout>
    ...
    <div class="{{ $cssNs }}">
        ...
        @include('admin.layouts.breadcrumb', [
            'title' => __('Bankaccounts'),
            'description' => __('Bankaccount Introduction'),
            'breadcrum' => [
                __('Bankaccounts') => '#',
            ],
        ])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @can('modules.bankaccount.add')

                                <div class="col-md-12 d-flex justify-content-end mb-4">

                                    <a href="{{ route('bankaccount.create') }}" class="btn btn-primary">{{ __('Bankaccount') }} {{ strtolower(__('Add')) }}</a>
